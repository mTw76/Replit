    ...
    <>
      ...
      <section className="section">
        <div className="two-col">
          ...
          <div>
            <p className="body-text">
              Markets frequently exhibit self-reinforcing dynamics — where price movements alter the
              conditions that produced them. These reflexive cycles generate systematic dislocations
              that disciplined, patient capital is positioned to exploit.
            </p>
            <p className="body-text">
              The firm's research process is oriented toward identifying these feedback loops across
              asset classes before they resolve. Precision in entry and exit is critical; the
              opportunity exists only within the cycle's formation and unwinding.
            </p>
            <p className="body-text">
              Alpha is generated by acting on these dislocations consistently and at scale. Risk
              management ensures that no single cycle, however compelling, dominates overall portfolio
              outcomes.
            </p>
          </div>
        </div>
