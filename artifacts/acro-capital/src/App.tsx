      ...
      <section className="section">
        <div className="two-col">
          <div>
            ...
            <h2 className="section-heading">Where markets create their own opportunities.</h2>
          </div>
          <div>
            <p className="body-text">
              Markets frequently exhibit self-reinforcing dynamics. Price movements alter the conditions
              that produced them. These reflexive cycles generate systematic dislocations that
              disciplined, patient capital is positioned to exploit.
            </p>
            <p className="body-text">
              The firm identifies these feedback loops across asset classes before they resolve.
              Volatility forecasting is integral to this process. Anticipated shifts in market
              volatility signal inflection points within reflexive cycles and determine when, and at
              what scale, capital is deployed.
            </p>
            <p className="body-text">
              Volatility forecasting improves the risk-adjusted return of individual positions and the
              resilience of the overall portfolio. Identifying the right opportunity is necessary but
              not sufficient. Alpha is a function of entering and exiting it correctly.
            </p>
          </div>
        </div>
      </section>
